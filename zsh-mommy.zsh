...
readonly ZSH_MOMMY_RESPONSE_TYPES=(POSITIVE NEGATIVE)
...
readonly ZSH_MOMMY_AFFECTIONATE_TERM_PLACEHOLDER='{AFFECTIONATE_TERM}'
readonly ZSH_MOMMY_MOMMYS_PRONOUN_PLACEHOLDER='{MOMMYS_PRONOUN}'
readonly ZSH_MOMMY_MOMMYS_ROLE_PLACEHOLDER='{MOMMYS_ROLE}'

ZSH_MOMMY_AFFECTIONATE_TERM=${ZSH_MOMMY_AFFECTIONATE_TERM:-(girl)}
ZSH_MOMMY_MOMMYS_PRONOUN=${ZSH_MOMMY_MOMMYS_PRONOUN:-(her)}
ZSH_MOMMY_MOMMYS_ROLE=${ZSH_MOMMY_MOMMYS_ROLE:-(mommy)}
